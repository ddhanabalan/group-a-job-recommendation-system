...
import JobDesciptionForm from './JobDesciption';
...
export default function JobVacancyForm({ data={}}) {
    ...
    const [domains, SetDomains] = useState(dta.skills?dta.skills.map(label => ({ tag: label, id: uuid() })) : []);
    ...
    const handleCheckboxChange = (checkedItems,  checkLimit, dataType) => {
     ...
     const handleTags = (tags) => {
        ...
        setPreferences({...preferences, "skills": tags.map(tagObj => {return(tagObj['tag'])}) });
    ...
    return (
        ...
        {preview?
                <div className="job-preview-container">
                    <JobDesciptionForm data={finalApplicationData} userType="employer"/>
                    <div className="post-vacancy-button">
                        <Button variant="outlined" onClick={handlePostVacancy} sx={{color: submit?"gray":"black", border: "2px solid #254CE1"}} startIcon={submit?<DoneIcon/>:<MailIcon />}>
                ...
                <div className="create-job-vacancy-container">
                    ...
                    <form noValidate onSubmit={handleSubmit(handlePreview)}>
                            ...
                            <div className='create-job-vacancy-div1'>
                                ...
                                <h1 className='create-job-vacancy-h1'>
                                    <div className="back-buton">
                                        <Link to="../employer/openings"><IconButton aria-label="back" sx={{display: "flex", alignItems: "center", width: 35, height: 35}}>
                            ...
                            <div className="create-job-vacancy-details">
                                ...
                                <div className="skill-divs">
                                    ...
                                    <div className='create-job-skill-field'>
                                        <AddTags value={domain} tags={domains} deleteFn={handleDeleteDomain} changeFn={handleChangeDomain} updateFn={handleDomain} onChange={handleTags} data={{ heading: "", inputPlaceholder: "Marketing", isLocation: false }} fSize="14px"/>
                                    </div>
                                </div>
                                        ...
                                        <div className="salary-fields">
                                            ...
                                            <CreateFormTextFields inputPlaceholder="Title" wparam="100px" 
                                                                defaultValue={dta.salary?dta.salary[0] || null:null}
                                                                    {...register("salary.0", { required: "Salary range is required" ,  
                                                                                            pattern: {
                                                                                                        value: /^[0-9]+$/,
                                            ...
                                            <CreateFormTextFields inputPlaceholder="Title" wparam="100px"
                                                                    ...
                                                                    {...register("salary.1", { required: "Salary range is required" ,  
                                                                    pattern: {
                                                                                value: /^[0-9]+$/,
                                                                                message: "Only numbers allowed"
                                                                            }})}/>
                        ...
                        <div className="post-button">
                            <Button variant="outlined" type="submit" sx={{color: submit?"gray":"black", border: "2px solid #07F407"}} startIcon={<RemoveRedEyeOutlinedIcon/>}>
