      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/employer-profile" element={<EmployerProfileSection  data={{
            userName: "NASA - National Aeronautics and Space Administration", first_name:"National Aeronautics and Space Administration", location: "Washington, D.C, USA", bio: "Explore the universe and discover our home planet with the official NASA page on <company name> . "
          }} />} />
          <Route path="/jobs" element={<JobSection />} />
          <Route path="/candidates" element={<CandidateSection />} />
