...
GRANT ALL PRIVILEGES ON modelDB.* TO 'modelsql'@'172.20.0.7';
FLUSH PRIVILEGES;
CREATE USER 'utilsql'@'172.20.0.6' IDENTIFIED BY 'utilsqlPass_32';
GRANT ALL PRIVILEGES ON utilDB.* TO 'utilsql'@'172.20.0.6';
FLUSH PRIVILEGES;
